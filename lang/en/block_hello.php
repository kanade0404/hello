...
/**
 * Strings for component 'block_hello', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   block_hello
...
$string['hello:addinstance'] = 'Add a new HTML block';
$string['hello:myaddinstance'] = 'Add a new HTML block to Dashboard';
$string['leaveblanktohide'] = 'leave blank to hide the title';
$string['newhelloblock'] = '(new HTML block)';
